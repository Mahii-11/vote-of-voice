...
import { Check, Vote, ChevronRight } from "lucide-react";
      ...
      <div className="p-6 flex flex-col items-center text-center relative z-10">
        ...
        <div className="w-full space-y-2 mb-6">
          <div className="flex justify-between items-end">
            ...
            <span
              className={`text-2xl font-bold ${poll.color.replace(
                "bg-",
                "text-"
              )}`}
            >
        ...
        <button
          ...
          active:scale-95 transition-all duration-300 flex items-center justify-center gap-2 group/btn"
